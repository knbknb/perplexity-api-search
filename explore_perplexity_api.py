...
def extract_json_from_html_report(report_file):
    '''
    Extracts JSON data from an HTML report file generated by newman cli tool and its "htmlextra" reporter.
    '''
...
def main(api_key):
    '''
    Parses the command line arguments, checks prerequisites,
